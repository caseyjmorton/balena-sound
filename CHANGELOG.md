...
* readme: Typo [Tomás Migone]
* multi-room: Add aarch64 Dockerfiles to pin images on RPi4 devices to 32 bits [Tomás Migone]
* readme: Minor fix. [Tomás Migone]
* readme: Remove ugly bars [Tomás Migone]
* readme: Updated readme, added multi room docs. [Tomás Migone]
* fleet-supervisor: Remove unnecessary variable [Tomás Migone]
* fleet-supervisor: Devices can now join after streaming starts and auto sync [Tomás Migone]
* multi-room: Add option to disable multi room [Tomás Migone]
* multi-room: minor tweaks to fleet supervisor [Tomás Migone]
* multi-room: Tidy up docker files [Tomás Migone]
* fleet-supervisor: typos [Tomás Migone]
* fleet-supervisor: remove some unnecessary docker flags [Tomás Migone]
* fleet-supervisor: Reorganize node code [Tomás Migone]
* fleet-supervisor: Added initial version [Tomás Migone]
* snapcast: Added snapcast server and client. Modified other services to work with it. [Tomás Migone]
* snapcast: First commit, add snapcast container [Tomás Migone]
